...
<footer class="btn btn-primary col-12" id="tempaltemo_footer">
    <div class="container">
...
<a href="http://wa.me/584141899016">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/240px-WhatsApp.svg.png" width="50" height="50"></a>
</div>
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li>
                        ...
                        <a class="text-decoration-none" href="tel:0212-578-44-68">0212-578-44-68</a> <br>
                        <i class="fa fa-phone fa-fw"></i>
                        <a class="text-decoration-none" href="http://wa.me/584141899016">+58-414.189.90.16</a>
...
-->
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    <li><a class="text-decoration-none" href="/detail/{{1}}">GinecoReport</a></li>
                    <li><a class="text-decoration-none" href="/detail/{{12}}">PediReport</a></li>
                    <li><a class="text-decoration-none" href="/detail/{{27}}">OrthoReport</a></li>
                    <li><a class="text-decoration-none" href="/detail/{{21}}">NeumoReport</a></li>
                </ul> 
            </div>
...
-->
            ...
            <div class="col-auto">
                ...
                <div class="input-group mb-2">
                    ...
                    <div class="input-group-text btn-success text-light">Suscríbete</div>
                </div>
            </div>
-->
        </div>
