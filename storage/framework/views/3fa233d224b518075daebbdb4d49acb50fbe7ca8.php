                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/detail/<?php echo e(1); ?>" class="h2 text-decoration-none text-dark">Ginecología</a>
<!--                                <p class="card-text">
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/detail/<?php echo e(12); ?>" class="h2 text-decoration-none text-dark">Pediatría</a>
<!--                                 <p class="card-text">
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/detail/<?php echo e(27); ?>" class="h2 text-decoration-none text-dark">Traumatología</a>
<!--                                <p class="card-text">
